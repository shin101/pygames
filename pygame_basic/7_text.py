...
game_font = pygame.font.Font(None, 40) #None will yield default font

total_time = 10 #must play game within 10 seconds
...
while running:
    ...
    elapsed_time = (pygame.time.get_ticks()-start_ticks) / 1000 #1000 to make it seconds, otherwise will show ms
...
pygame.time.delay(2000) #2000ms which is about 2 sec
